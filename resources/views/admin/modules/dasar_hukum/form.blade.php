<div class="modal fade" id="modal-form" tabindex="-1" role="dialog" aria-labelledby="formModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <form id="form-gambaran" action="{{ route('dasar_hukum.store') }}" method="post"  data-toggle="validator" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="md-input-wrapper" id="edit_editor">
            ...
            <textarea name="isi_dasar_hukum"></textarea>
            <span class="help-block with-errors"></span>
          </div>
        </div>
