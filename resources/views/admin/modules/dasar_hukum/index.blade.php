...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-header-text">Dasar Hukum List</h5>
                    {{-- button form modal --}}
                        ...
                        <div class="col-md-12">
                            ...
                            <form id="search-form" class="form-inline" role="form">
                                <div class="form-group">
                                    <input type="text" id="dasar_hukum" name="dasar_hukum" class="form-control" placeholder="Role Name">
                                </div>
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-sm-12 table-responsive">
                            <table id="dasar-hukum-table" class="table table-stripped">
                                <thead>
                                    <tr>
                                        <th>Isi Dasar Hukum</th>
        ...
        {{-- include form modal --}}
        @include('admin.modules.dasar_hukum.form')
@endsection
...
<script type="text/javascript">
    var oTable = $('#dasar-hukum-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('admin.api.dasar_hukum') }}",
                data: function (d) {
                    d.isi_dasar_hukum = $('input[name=isi_dasar_hukum]').val();
                }
            },
            columns: [
                {data: 'isi_dasar_hukum', name: 'isi_dasar_hukum'},
    ...
    function editForm(id) {
        ...
        $('#modal-form form')[0].reset();
        $('form[action]').attr("action","{{ url('admin/dasar_hukum') }}"+"/"+id);
        $.ajax({
          url: "{{ url('admin/api/dasar_hukum/ajaxtampil') }}" + '/' + id,
          type: "GET",
          // dataType: "JSON",
          success: function(data) {
            $('#modal-form').modal('show');
            $('.modal-title').text('Edit Dasar Hukum');
            // $('#id').val(data.id);
