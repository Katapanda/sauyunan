<div class="modal fade" id="modal-form" tabindex="-1" role="dialog" aria-labelledby="formModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <form id="form-gambaran" action="{{ route('tupoksi.store') }}" method="post"  data-toggle="validator" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="md-input-wrapper" id="edit_editor">
            {{ ($errors->has('isi_tupoksi')) ? $errors->first('isi_tupoksi') : '' }}
            <textarea name="isi_tupoksi"></textarea>
